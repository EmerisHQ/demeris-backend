...
require (
	github.com/allinbits/demeris-api-server v0.0.0-20220301172343-65f9ffe98599
	k8s.io/api v0.21.1
)
...
require (
	...
	github.com/allinbits/sdk-service-meta v0.0.0-20220225122854-eb00092170cc // indirect
