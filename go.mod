...
require (
	github.com/allinbits/demeris-api-server v0.0.0-20220217054035-4cc00143aea9
	k8s.io/api v0.21.1
)
...
require (
	...
	github.com/allinbits/sdk-service-meta v0.0.0-20220114142340-a44e073d0b27 // indirect
